...
class SessionSerializer(serializers.ModelSerializer):
    class Meta:
        model = Session
        fields = ['session_name', 'player_one_name', 'player_two_name', 'player_one_score', 'player_two_score', 'turn', 'created_at', 'prompt', 'prompt_guess', 'image_url', 'selected_image_url']
